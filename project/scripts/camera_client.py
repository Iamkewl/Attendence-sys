...
ROOM_ID = 1            # Matches seeded room mapping
CAMERA_ID = "Cam-A1"
...
async def upload_snapshot(frame_bytes: bytes):
    ...
    async with httpx.AsyncClient() as client:
        ...
        headers = {"X-Signature": signature, "X-Device-Secret": SECRET_KEY}
...
async def listen_for_capture_signals():
    ...
    ws_uri = f"{WS_URL}/ws/device/{DEVICE_ID}?room_id={ROOM_ID}&secret={SECRET_KEY}"
